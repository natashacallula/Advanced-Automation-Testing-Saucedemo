...
describe('Login Testing with various username and password combinations', () => {
    beforeEach(() => {
    ...
    it('Login using registered username & password 1.',() => {
     ...
     it('Login using registered username & password 4.',() => {
        ...
        cy.fixture("sauce").then(sauce => {
          ...
          it('Login using registered username & password 5.',() => {
        ...
        cy.fixture("sauce").then(sauce => {
          ...
          it('Login using registered username & password 6.',() => {
        
        cy.fixture("sauce").then(sauce => {
            const username = sauce.username6
            const password = sauce.password1
     ...
     it('Login using unregistered username & registered password.',() => {
        ...
        cy.fixture("sauce").then(sauce => {
            const username = sauce.username7
            const password = sauce.password1
...
describe('Functional Testing using standard_user account', () => {
    beforeEach(() => {
        cy.visit('https://www.saucedemo.com/')
        cy.url().should('include', 'saucedemo.com')
      });
...
describe('Functional Testing using problem_user account', () => {
    beforeEach(() => {
        cy.visit('https://www.saucedemo.com/')
        cy.url().should('include', 'saucedemo.com')
      });
...
describe('Functional Testing using performance_glitch_user account', () => {
    beforeEach(() => {
        cy.visit('https://www.saucedemo.com/')
        cy.url().should('include', 'saucedemo.com')
      });
...
describe('Functional Testing using error_user account', () => {
    beforeEach(() => {
        cy.visit('https://www.saucedemo.com/')
        cy.url().should('include', 'saucedemo.com')
      });
...
describe('Functional Testing using visual_user account', () => {
    beforeEach(() => {
        cy.visit('https://www.saucedemo.com/')
        cy.url().should('include', 'saucedemo.com')
      });
